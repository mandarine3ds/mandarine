...
void ConfigureGeneral::SetConfiguration() {
    ...
    ui->toggle_custom_cpu_ticks->setChecked(Settings::values.use_custom_cpu_ticks.GetValue());
    ui->custom_cpu_ticks_spinbox->setEnabled(Settings::values.use_custom_cpu_ticks.GetValue());
...
void ConfigureGeneral::ApplyConfiguration() {
    ...
    Settings::values.use_custom_cpu_ticks = ui->toggle_custom_cpu_ticks->isChecked();
