 ...
 * be mapped.
 */
constexpr u32 MANDARIN_PAGE_SIZE = 0x1000;
constexpr u32 MANDARIN_PAGE_MASK = MANDARIN_PAGE_SIZE - 1;
constexpr int MANDARIN_PAGE_BITS = 12;
constexpr std::size_t PAGE_TABLE_NUM_ENTRIES = 1 << (32 - MANDARIN_PAGE_BITS);
