...
jboolean Java_io_github_mandarin3ds_mandarin_utils_SystemSaveGame_getIsSystemSetupNeeded(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj) {
    return cfg->IsSystemSetupNeeded();
}

void Java_io_github_mandarin3ds_mandarin_utils_SystemSaveGame_setSystemSetupNeeded(
...
jshortArray Java_io_github_mandarin3ds_mandarin_utils_SystemSaveGame_getBirthday(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj) {
...
jint Java_io_github_mandarin3ds_mandarin_utils_SystemSaveGame_getSystemLanguage(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj) {
...
jint Java_io_github_mandarin3ds_mandarin_utils_SystemSaveGame_getSoundOutputMode(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj) {
...
void Java_io_github_mandarin3ds_mandarin_utils_SystemSaveGame_regenerateConsoleId(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj) {
