...
Java_io_github_mandarin3ds_mandarin_model_GameInfo_initialize(JNIEnv* env, jclass, jstring j_path) {
...
JNIEXPORT void JNICALL Java_io_github_mandarin3ds_mandarin_model_GameInfo_finalize(JNIEnv* env,
                                                                                   jobject obj) {
