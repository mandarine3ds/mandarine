...
Java_io_github_mandarin3ds_mandarin_applets_SoftwareKeyboard_ValidateFilters(JNIEnv* env,
                                                                             jclass clazz,
                                                                             jstring text);

JNIEXPORT jobject JNICALL
Java_io_github_mandarin3ds_mandarin_applets_SoftwareKeyboard_ValidateInput(JNIEnv* env,
                                                                           jclass clazz,
                                                                           jstring text);
}
