...
static void PrintVersion() {
    std::cout << "Mandarin dedicated room " << Common::g_scm_branch << " " << Common::g_scm_desc
              << " Libnetwork: " << Network::network_version << std::endl;
}

/// The magic text at the beginning of a mandarin-room ban list file.
static constexpr char BanListMagic[] = "MandarinRoom-BanList-1";
...
int main(int argc, char** argv) {
    ...
    if (!announce && enable_mandarin_mods) {
        ...
        std::cout << "Can not enable Mandarin Moderators for private rooms\n\n";
    }
